...
public class ResultLists {
    ...
    static {
        ...
        PALE_OAK_SAPLING_RESULTS.add(new ChanceResult(new ItemStack(Items.PALE_OAK_LOG, 2), 1.0f));
        PALE_OAK_SAPLING_RESULTS.add(new ChanceResult(new ItemStack(Items.PALE_OAK_SAPLING), 0.2f));
        PALE_OAK_SAPLING_RESULTS.add(new ChanceResult(new ItemStack(Items.STICK), 0.1f));

        CACTUS_RESULTS.add(new ChanceResult(new ItemStack(Items.CACTUS, 1), 0.9f));
        CACTUS_RESULTS.add(new ChanceResult(new ItemStack(Items.CACTUS_FLOWER, 1), 0.1f));
